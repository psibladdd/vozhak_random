...
const App = () => {
    ...
    return (//3
        <div style={{ position: 'fixed', top: 0, left:0,height:'100vh',width: '100vw'
            ...
            >
           {isNight ? 'Сделать день' : 'Селать ночь'}
           </button>
           ...
           <StreetLamp position={[0,0,1]} isNight={isNight}/>
                 ...
                 <Cube rot={[0, Math.PI/4, 0]} size={[0.8, 1, 0.3]} color={"purple"} pos={[0.7,0.4,0]}/>

                 <Cube rot={[0, Math.PI/4, 0]} size={[0.8, 1, 0.3]} color={"blue"} pos={[-0.7,0.4,0]}/>
